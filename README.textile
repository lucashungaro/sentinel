...
On Rails, you can install as plugin:
...
And... that's it! Every time the subject (in this case, MyClass) method is called, the specified observer method will be called too. By default, the observer method is called *after* the subject method, but you can call it *before* the execution (will see it in the next example).
