...
To use it, first you'll need an observer class that responds to a method called _notify_ (which can be a class or instance method). All the observed method's arguments will be passed to this method, hence the _*args_.
